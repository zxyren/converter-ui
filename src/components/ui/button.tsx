...
const buttonVariants = cva(
  "inline-flex items-center justify-center leading-none gap-2 cursor-pointer whitespace-nowrap rounded-md text-sm font-medium leading-none transition-colors focus-visible:outline-none focus-visible:ring-none focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
