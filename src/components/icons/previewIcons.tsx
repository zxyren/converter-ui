...
export function DOCXIcon({ }: IconProps) {
    return (
...
export function DOCIcon({ }: IconProps) {
    return (
        <svg width={35} height={35} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
...
export function ImageIcon({ }: IconProps) {
    return (
...
export function VideoIcon({ }: IconProps) {
    return (
        <svg width={30} height={30} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
...
export function AudioIcon({ }: IconProps) {
    return (
        <svg width={30} height={30} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
...
export function FontIcon({ }: IconProps) {
    return (
        <svg width={30} height={30} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
...
export function DocsIcon({ }: IconProps) {
    return (
        <svg width={30} height={30} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
...
export function DevIcon({ }: IconProps) {
    return (
        <svg width={30} height={30} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
