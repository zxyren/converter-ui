...
export function PDFIcon({ size = 24, className = "", strokeWidth = 2 }: IconProps) {
    return (
...
export function DOCXIcon({ size = 24, className = "", strokeWidth = 2 }: IconProps) {
    return (
        <svg width={size} height={size} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
...
export function DOCIcon({ size = 24, className = "", strokeWidth = 2 }: IconProps) {
    return (
        <svg width={size} height={size} fill="none" viewBox="0 0 40 40">
            <path
                stroke="#D5D7DA"
